...
of every corridor in between, figure out how many bunnies can safely make it
...
8 bunnies to 4 and 5, such as 2/6 and 6/6, but the final answer remains the same.)
