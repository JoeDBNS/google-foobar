...
def spy_snippets1(document, searchTerms):
...
# Fails Secret Test Case #5
def spy_snippets2(document, searchTerms):
...
def spy_snippets3(document, searchTerms):
    docTerms = document.split()
    srcTermsDict = {term: [] for term in searchTerms}
    snippits = []
    snippitValues = []
...
def spy_snippets4(document, searchTerms):
...
# Fails Secret Test Case #5
def spy_snippets5(document, searchTerms):
    docTerms = document.split()
    srcTermsDict = {term: [] for term in searchTerms}
    snippets = []
    snippetValues = []
...
# Fails Secret Test Case #5
def spy_snippets6(document, searchTerms):
    docTerms = document.split()
    srcTermsDict = {term: [] for term in searchTerms}
    snippets = []
...
def Test_spy_snippets(testCase, document, searchTerms):
    retVal = spy_snippets6(document, searchTerms)
    goodVal = answer(document, searchTerms)
    if retVal == goodVal:
...
Test_spy_snippets(testCase, document, searchTerms)
